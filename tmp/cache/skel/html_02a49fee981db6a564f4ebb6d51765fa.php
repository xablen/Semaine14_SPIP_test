...
function BOUCLE_articleshtml_02a49fee981db6a564f4ebb6d51765fa(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_postdates('articles.date',''));
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/inclure/recents.html','html_02a49fee981db6a564f4ebb6d51765fa','_articles',1,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'</abbr>' .
(($t1 = strval(supprimer_tags(recuperer_fond('modeles/lesauteurs', array('objet'=>'article','id_objet' => $Pile[$SP]['id_article'],'id_article' => $Pile[$SP]['id_article']), array('trim'=>true, 'compil'=>array('squelettes/inclure/recents.html','html_02a49fee981db6a564f4ebb6d51765fa','_articles',7,$GLOBALS['spip_lang'])), ''))))!=='' ?
		((	', ' .
...
'
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_articles @ squelettes/inclure/recents.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette squelettes/inclure/recents.html
// Temps de compilation total: 11.873 ms
//

function html_02a49fee981db6a564f4ebb6d51765fa($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {

	if (isset($Pile[0]["doublons"]) AND is_array($Pile[0]["doublons"]))
		$doublons = nettoyer_env_doublons($Pile[0]["doublons"]);

	$connect = '';
	$page = (($t1 = BOUCLE_articleshtml_02a49fee981db6a564f4ebb6d51765fa($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
')) :
	...
	return analyse_resultat_skel('html_02a49fee981db6a564f4ebb6d51765fa', $Cache, $page, 'squelettes/inclure/recents.html');
}
?>
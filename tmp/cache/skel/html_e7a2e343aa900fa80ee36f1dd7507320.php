...
// Temps de compilation total: 40.318 ms
//
...
.formulaire_configurer_multilinguisme #langues_bloquees .editer,
.formulaire_configurer_multilinguisme #langues_proposees .editer { padding:0 5px;margin-' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'right', null),true)) .
':10px;float:' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'left', null),true)) .
';width:45%;clear:none;}

...
quete_condition_postdates('documents.date_publication',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/inclure/documents.html','html_ec8f89e79d12293c7a104ae7428e27e3','_documents_portfolio',2,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
quete_condition_postdates('documents.date_publication',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/inclure/documents.html','html_ec8f89e79d12293c7a104ae7428e27e3','_afficher_document',24,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
filtrer('image_graver',filtrer('image_reduire',
	...
	'recurs'=>(++$recurs)), array('compil'=>array('squelettes-dist/inclure/documents.html','html_ec8f89e79d12293c7a104ae7428e27e3','_afficher_document',25,$GLOBALS['spip_lang']), 'trim'=>true), ''))
,'672','*')) .
'
');
	}
...
quete_condition_postdates('documents.date_publication',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/inclure/documents.html','html_ec8f89e79d12293c7a104ae7428e27e3','_documents_joints',42,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
quete_condition_postdates('documents.date_publication',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/inclure/documents.html','html_ec8f89e79d12293c7a104ae7428e27e3','_documents_decompte',33,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'
' .
(($Numrows['_documents_decompte']['total'] == '1') ? trim(recuperer_fond( 'modeles/emb' , array('id_document' => $Pile[$SP]['id_document'] ), array('compil'=>array('squelettes-dist/inclure/documents.html','html_ec8f89e79d12293c7a104ae7428e27e3','_documents_decompte',35,$GLOBALS['spip_lang'])), _request('connect'))):''));
	}
	$iter->free();
	}
	if (defined("_BOUCLE_PROFILER")
...
// Temps de compilation total: 122.537 ms
//

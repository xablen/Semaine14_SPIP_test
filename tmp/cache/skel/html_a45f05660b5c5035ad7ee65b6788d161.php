...
/*
 * Squelette : squelettes/inc/inc-art-documents.html
 * Date :      Wed, 23 Dec 2015 13:11:16 GMT
 * Compile :   Tue, 12 Jan 2016 10:43:03 GMT
 * Boucles :   _documents_portfolio, _afficher_document, _documents_decompte, _documents_joints
 */ 

function BOUCLE_documents_portfoliohtml_a45f05660b5c5035ad7ee65b6788d161(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_postdates('documents.date_publication',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/inc/inc-art-documents.html','html_a45f05660b5c5035ad7ee65b6788d161','_documents_portfolio',2,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
	...
	parametre_url(vider_url(urlencode_1738(generer_url_entite($Pile[$SP]['id_article'], 'article', '', '', true))),'id_document',$Pile[$SP]['id_document']) .
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_documents_portfolio @ squelettes/inc/inc-art-documents.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_afficher_documenthtml_a45f05660b5c5035ad7ee65b6788d161(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_postdates('documents.date_publication',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/inc/inc-art-documents.html','html_a45f05660b5c5035ad7ee65b6788d161','_afficher_document',18,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
(($t1 = strval(filtrer('image_graver',filtrer('image_reduire',
	...
	'recurs'=>(++$recurs)), array('compil'=>array('squelettes/inc/inc-art-documents.html','html_a45f05660b5c5035ad7ee65b6788d161','_afficher_document',0,$GLOBALS['spip_lang']), 'trim'=>true), ''))
,'520','0'))))!=='' ?
		((	'<a href="' .
...
'
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_afficher_document @ squelettes/inc/inc-art-documents.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_documents_decomptehtml_a45f05660b5c5035ad7ee65b6788d161(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_postdates('documents.date_publication',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/inc/inc-art-documents.html','html_a45f05660b5c5035ad7ee65b6788d161','_documents_decompte',30,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'
' .
(($Numrows['_documents_decompte']['total'] == '1') ? trim(recuperer_fond( 'modeles/emb' , array('id_document' => $Pile[$SP]['id_document'] ), array('compil'=>array('squelettes/inc/inc-art-documents.html','html_a45f05660b5c5035ad7ee65b6788d161','_documents_decompte',32,$GLOBALS['spip_lang'])), _request('connect'))):''));
	}
	$iter->free();
	}
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_documents_decompte @ squelettes/inc/inc-art-documents.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_documents_jointshtml_a45f05660b5c5035ad7ee65b6788d161(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_postdates('documents.date_publication',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/inc/inc-art-documents.html','html_a45f05660b5c5035ad7ee65b6788d161','_documents_joints',39,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_documents_joints @ squelettes/inc/inc-art-documents.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette squelettes/inc/inc-art-documents.html
// Temps de compilation total: 104.614 ms
//

function html_a45f05660b5c5035ad7ee65b6788d161($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'
' .
(($t1 = BOUCLE_documents_portfoliohtml_a45f05660b5c5035ad7ee65b6788d161($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
'
	...
	' .
BOUCLE_afficher_documenthtml_a45f05660b5c5035ad7ee65b6788d161($Cache, $Pile, $doublons, $Numrows, $SP) .
'


' .
BOUCLE_documents_decomptehtml_a45f05660b5c5035ad7ee65b6788d161($Cache, $Pile, $doublons, $Numrows, $SP) .
'



	' .
(($t1 = BOUCLE_documents_jointshtml_a45f05660b5c5035ad7ee65b6788d161($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
');
	...
	return analyse_resultat_skel('html_a45f05660b5c5035ad7ee65b6788d161', $Cache, $page, 'squelettes/inc/inc-art-documents.html');
}
?>